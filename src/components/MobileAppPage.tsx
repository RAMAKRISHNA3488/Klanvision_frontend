      ...
      <section style={{ 
        ...
        <div className="container" style={{ position: 'relative', zIndex: 10 }}>
          <motion.div style={{ opacity, scale }}>
            ...
            >
              <a href="https://klanvision-frontend.vercel.app/" style={{ color: '#8B5CF6', display: 'flex', alignItems: 'center', gap: 8, textDecoration: 'none', fontSize: 14, fontWeight: 700, marginBottom: 40, letterSpacing: '1px' }}>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                <div>
                  ...
                  <div style={{ display: 'flex', flexWrap: 'wrap', gap: 24 }}>
                    <a href="https://klanvision-frontend.vercel.app/#contact-form" className="btn-primary" style={{ textDecoration: 'none', padding: '20px 48px', background: '#8B5CF6', color: 'white', borderRadius: '16px', fontWeight: 800, fontSize: 18, display: 'flex', alignItems: 'center', gap: 12, boxShadow: '0 20px 40px rgba(139,92,246,0.3)' }}>
